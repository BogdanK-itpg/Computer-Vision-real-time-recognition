# Computer Vision Application (Python Reference Implementation)

Production-ready computer vision application using Google MediaPipe Tasks API and Python 3.12+.

> **🌐 Web version available**: This project has been ported to a Next.js web application running entirely in the browser. See the [root README](../README.md) for the web app.
